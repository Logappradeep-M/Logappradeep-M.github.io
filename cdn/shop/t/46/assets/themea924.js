...
Line 271:2 Transforming const to the configured target environment ("es5") is not supported yet
Line 427:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 430:10 Transforming let to the configured target environment ("es5") is not supported yet
Line 865:56 Transforming destructuring to the configured target environment ("es5") is not supported yet
Line 866:10 Transforming const to the configured target environment ("es5") is not supported yet
Line 867:10 Transforming const to the configured target environment ("es5") is not supported yet
Line 872:19 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 873:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 874:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 877:10 Transforming const to the configured target environment ("es5") is not supported yet
